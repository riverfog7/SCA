...
class QwenTrainer(Trainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        if thinker_loss is not None and talker_loss is not None and mtp_loss is not None:
    ...
    def log(self, logs: Dict[str, float], start_time: Optional[float] = None, **kwargs) -> None:  # type: ignore[override]
